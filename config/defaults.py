...
_C.AUGMENT.FLIP_SUPPORT = True
_C.AUGMENT.CUTOUT_PROBA = 0.5
_C.AUGMENT.CUTOUT_PROBA_SUPPORT = 0.5
_C.AUGMENT.CUTOUT_SCALE = (0.02, 0.2)
_C.AUGMENT.CUTOUT_LEVEL = 'image'
_C.AUGMENT.NOISE_FEATURES = 0.1
_C.AUGMENT.RANDOM_CROP_PROBA = 0.5
...
_C.LOSSES = CN()
_C.LOSSES.OBJECT_SIZES_OF_INTEREST = [
    [-1, 64],
    [64, 128],
    [128, 256],
    [256, 512],
...
#     [96, 1000000],
# ]
_C.LOSSES.ADAPTIVE_RADIUS_SAMPLE_REGION = False
